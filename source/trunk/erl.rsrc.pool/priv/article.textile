...
<code>resource_factory</code> module defines '''behaivior''' of generic resource factory. We have to implement this 
'''behaivior''' while designing of resource factory module for given resource. The module has to consist following functions:

; <code>create(Resource_metadata)</code> : The function creates new instance of the resource. In Erlang word this is a new
: process in most cases. <code>Resource_metadata</code>
; <code>destroy(Resource_metadata, Resource)</code> : bla bla.
; <code>validate(Resource_metadata, Resource)</code> : ok
; <code>activate(Resource_metadata, Resource)</code> : ok
; <code>passivate(Resource_metadata, Resource)</code> : ok
: doki
